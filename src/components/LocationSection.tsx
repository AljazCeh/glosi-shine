...
const LocationSection = () => {
  return (
    <section id="lokacija" className="py-16 md:py-24 bg-[hsl(220,8%,12%)]">
      <div className="container">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="md:col-span-2 rounded-lg overflow-hidden border border-border/60 min-h-[280px]">
            <iframe
